...
from inflexion import InflexionGame
...
if human_vs_cpu:
    ...
    n2 = NNet(g)
    n2.load_checkpoint('./pretrained_models/inflexion/pytorch/', '7x7_100checkpoints_best.pth.tar')
...
arena = Arena.Arena(n1p, player2, g, display=InflexionGame.display)
